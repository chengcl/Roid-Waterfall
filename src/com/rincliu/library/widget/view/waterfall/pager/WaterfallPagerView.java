...
public class WaterfallPagerView extends PullToRefreshScrollView{
	 ...
	 * @param header
	 */
	public void createView(View header, WaterfallItemHandler waterfallItemHandler){
	...
	private WaterfallPagerAdapter waterfallAdapter;
	
	/**
	 * 
	 * @param waterfallAdapter
	 */
	public void autoLoad(WaterfallPagerAdapter<?> waterfallAdapter){
		this.waterfallAdapter=waterfallAdapter;
		waterfallAdapter.setWaterfallView(this);
		waterfallAdapter.load();
	}
	...
	void setOnWaterfallRefreshListener(OnWaterfallRefreshListener onWaterfallRefreshListener){
	...
	void setOnWaterfallScrollListener(OnWaterfallScrollListener onWaterfallScrollListener){
		this.onWaterfallScrollListener=onWaterfallScrollListener;
	}
	
	WaterfallItemHandler waterfallItemHandler; 
	 ...
	 */
	public void setOnWaterfallItemClickListener(
			OnWaterfallItemClickListener onWaterfallItemClickListener) {
